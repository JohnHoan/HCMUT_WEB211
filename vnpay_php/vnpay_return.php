        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                    ...
                    <label>
                        ...
                        if ($secureHash == $vnp_SecureHash) {
                            if ($_GET['vnp_ResponseCode'] == '00') {
                                ...
                                // Tìm hiểu cách Post lại cho thằng CartController làm.
                                // require to get $con to database


                                $conn = new mysqli("localhost","root","","web211");
                                $taikhoan = '';
                    ...
                    <br>
                    <a href="http://localhost/web211/HomeController/index">
